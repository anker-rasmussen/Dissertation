...
\subsubsection{Shamir Secret Sharing for MPC}
% - N-party support, honest-majority assumption acceptable for auctions
% - MP-SPDZ provides production-grade implementation with shamir-party.x
% - Tradeoff: requires honest majority (N/2+1). With N=3, one corrupt party breaks privacy.
% - Alternative considered: SPDZ (dishonest majority) — higher overhead, not needed for prototype
