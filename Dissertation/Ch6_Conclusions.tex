...
the cost of doing so can be measured.  To the author's knowledge, no prior empirical data existed on the overhead
of tunnelling MPC through onion-routed messaging.
