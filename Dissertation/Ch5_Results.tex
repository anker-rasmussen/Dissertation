...
%   5. MPC execution (MASCOT, N parties)
...
% - N=2 minimum: MASCOT tolerates up to N-1 corrupt parties (dishonest majority)
% - With N=2: even 1 corrupt party is tolerated (only privacy of corrupt party's input lost)
% - With N=10: up to 9 corrupt parties tolerated
% - Severity: Low — MASCOT provides stronger guarantees than Shamir for small auctions
